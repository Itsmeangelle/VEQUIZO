...
if ($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    if ($stmt->execute()){
        $is_success = true;
        header("Location: http://127.0.0.1/vequizo/login.php");
...
<body>
    ...
    <form class="login-container register-container" id="signup" method="post">
        ...
        <p href="" class="link" onclick="">Already Have An Account? Log In Here</p>
    </form>
</body>
